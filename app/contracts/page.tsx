    ...
    <>
      ...
      >
        <div className="p-6 bg-muted/30">
          <h2 className="text-xl font-semibold mb-2">Contract Process</h2>
          <p className="text-sm text-muted-foreground mb-6">
            Complete these steps to finalize your loan agreement
          </p>
            ...
            {[
              {
                step: 1,
                title: "Review Terms",
                description: "Carefully review all loan terms and conditions"
              },
              {
                step: 2,
                title: "Digital Signature",
                description: "Agree to all terms and complete your electronic signature"
              },
              {
                step: 3,
                title: "Loan Disbursement",
                description: "Receive your loan amount within 1-2 business days"
              }
            ].map((item, index) => (
              <motion.div
                key={item.step}
          ...
          >
            <p className="text-sm text-muted-foreground">
              <span className="font-medium text-primary">Important:</span> Contract signing requires identity verification and agreement to all terms. Your loan repayment schedule will begin after contract completion.
            </p>
          </motion.div>
        </div>
      </motion.div>
