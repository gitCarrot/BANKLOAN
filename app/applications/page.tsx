        ...
        >
          <div className="p-6 bg-muted/30">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Follow these steps to complete your loan application process
            </p>
              ...
              {[
                {
                  step: 1,
                  title: "Complete Form",
                  description: "Fill in your personal information and desired loan amount"
                },
                {
                  step: 2,
                  title: "Review Process",
                  description: "Our team evaluates your application based on provided information"
                },
                {
                  step: 3,
                  title: "Check Results",
                  description: "View your approval status and approved loan amount"
                },
                {
                  step: 4,
                  title: "Sign Contract",
                  description: "Complete the process by signing your loan agreement"
                }
              ].map((item, index) => (
                <motion.div
                  key={item.step}
            ...
            >
              <p className="text-sm text-muted-foreground">
                <span className="font-medium text-primary">Note:</span> Application results are typically available within 1-2 business days. You'll receive an email notification, and you can check your status anytime using your application ID.
              </p>
            </motion.div>
          </div>
        </motion.div>
